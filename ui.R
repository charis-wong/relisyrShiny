               ...
               box(
                 ...
                 p("ReLiSyR-MND is a crowdsourced three-part machine learning assisted living systematic review of:",
                   ...
                   actionBttn(
                     ...
                     style = "pill", 
                     color = "primary",
                     onclick ="window.open('https://camarades.shinyapps.io/ICAN-MND-demo')"
                     
                   ),
                   actionBttn(
                     inputId = "mndsolesct",
                     label = "MND-SOLES-CT demo",
                     style = "pill",
                     color = "primary",
                     
                     onclick ="window.open('https://camarades.shinyapps.io/MND-SOLES-CT-demo')"
